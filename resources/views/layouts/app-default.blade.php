            ...
            <a href="{{ route('index') }}" class="navbar-brand">
                ...
                <div class="logo-main">
                    <div class="logo-normal">
                       <img src="{{ asset('images/logo-header.png') }}" alt="" style="width: auto; height: 50px;">
                    </div>
                    <div class="logo-mini">
          ...
          {{-- SIDEBAR KHUSUS DASHBOARD ADMIN --}}          
            ...
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                      <a class="nav-link {{ request()->routeIs('dash') ? 'active' : '' }}" aria-current="page" href="{{ route('dash') }}">
                        ...
                        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="{{ route('siswa-table') }}">
                                    ...
                                    <span class="item-name">Kelola Siswa</span>
                                </a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link " href="{{ route('user-external-table') }}">
                                  ...
                                  <i class="sidenav-mini-icon"> D </i>
                                  <span class="item-name">Kelola User External</span>
                              </a>
                          </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                      <a class="nav-link {{ request()->routeIs('transaction-history') ? 'active' : '' }}" aria-current="page"
                        href="{{ route('transaction-history') }}" target="_blank">
                        <i class="icon">
