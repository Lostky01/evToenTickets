        ...
        <div class="container mt-5" style="border-radius: 15px; padding: 2%;">
            ...
            <div class="container p-4 mt-5" style="background: white; border-radius: 10px;">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="form-group mt-3">
                        <label for="name" class="mb-2" style="font-weight: 500; color: #29366D">Nama Lengkap</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Masukkan Nama Lengkap">
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
